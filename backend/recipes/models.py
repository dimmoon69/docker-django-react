...
class Recipe(models.Model):
    ...
    name = models.CharField(
        max_length=200, db_index=True, verbose_name="Название рецепта"
    )
    ...
    tags = models.ManyToManyField(Tag, verbose_name="Теги рецепта", through="RecipeTag")
    ...
    cooking_time = models.PositiveSmallIntegerField(
        validators=[MinValueValidator(1, message=settings.VALIDATOR_MESSAGE)],
        verbose_name="Время приготовления (в минутах)",
        help_text="Время приготовления (в минутах)",
    )
    pub_date = models.DateTimeField("Дата и время написания рецепта", auto_now_add=True)
...
class RecipeIngredient(models.Model):
    ...
    class Meta:
        ...
        constraints = (
            models.UniqueConstraint(
                fields=("ingredient", "recipe_id"), name="unique_ingredients_recipes"
            ),
        )
